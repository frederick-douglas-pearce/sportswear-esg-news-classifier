...
| `tests/` | Comprehensive test suite (921 tests) |
...
The project includes a comprehensive test suite with **921 tests** covering data collection, labeling pipelines, ML deployment, retraining workflows, MLOps modules, and agent orchestration.
